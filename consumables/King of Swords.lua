...
SMODS.Consumable {
    ...
    loc_txt = {
        name = 'King of Swords',
        text = {
            [1] = 'Draws {C:attention}1{} card to hand for every King in your deck',
        ...
        if G.hand and #G.hand.cards > 0 then
            if G.hand and #G.hand.cards > 0 then
                G.E_MANAGER:add_event(Event({
                    ...
                    delay = 0.4,
                    func = function()
                        card_eval_status_text(used_card, 'extra', nil, nil, nil, {message = "+"..tostring((function() local count = 0; for _, card in ipairs(G.playing_cards or {}) do if card.base.id == 13 then count = count + 1 end end; return count end)()).." Cards Drawn", colour = G.C.BLUE})
